...
export const CONNECTION_ICON: Record<string, { Ic?: Icon; img?: string }> = {
  ...
  ebay: { img: "https://m.doughmination.gay/img/icons/ebay.svg" },
  tiktok: { Ic: Tiktok },
  bungie: { img: "https://m.doughmination.gay/img/icons/bungie.svg" },
  playstation: { Ic: Playstation },
  paypal: { Ic: Paypal },
  instagram: { Ic: Instagram },
  xbox: { Ic: Xbox },
  crunchyroll: { img: "https://m.doughmination.gay/img/icons/crunchyroll.svg" },
  battlenet: { img: "https://m.doughmination.gay/img/icons/battlenet.svg" },
  github: { Ic: Github },
  epicgames: { img: "https://m.doughmination.gay/img/icons/epic.svg" },
  riotgames: { img: "https://m.doughmination.gay/img/icons/riot.svg" },
  leagueoflegends: { img: "https://m.doughmination.gay/img/icons/league.svg" },
  steam: { Ic: Steam },
  roblox: { img: "https://m.doughmination.gay/img/icons/roblox.svg" },
  twitter: { Ic: TwitterX },
  bluesky: { Ic: Bluesky },
