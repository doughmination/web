...
export const CONNECTION_ICON: Record<string, { Ic?: Icon; img?: string }> = {
  ...
  ebay: { img: "/icons/ebay.svg" },
  tiktok: { Ic: Tiktok },
  bungie: { img: "/icons/bungie.svg" },
  playstation: { Ic: Playstation },
  paypal: { Ic: Paypal },
  instagram: { Ic: Instagram },
  xbox: { Ic: Xbox },
  crunchyroll: { img: "/icons/crunchyroll.svg" },
  battlenet: { img: "/icons/battlenet.svg" },
  github: { Ic: Github },
  epicgames: { img: "/icons/epic.svg" },
  riotgames: { img: "/icons/riot.svg" },
  leagueoflegends: { img: "/icons/league.svg" },
  steam: { Ic: Steam },
  roblox: { img: "/icons/roblox.svg" },
  twitter: { Ic: TwitterX },
  bluesky: { Ic: Bluesky },
